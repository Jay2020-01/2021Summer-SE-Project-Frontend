    ...
    <v-container class="my-5">
      <v-row>
        <v-col offset="2" cols="8">
          <v-row>
            <v-col cols="5">
              <v-card class="mx-auto" width="450" height="420">
                <v-card-subtitle class="text-h5">个人信息</v-card-subtitle>
                <v-card-text>
          ...
          <div class="text--primary">
            ...
            "an eleemosynary educational institution."
                ...
                <v-card-actions>
                  <v-btn text color="teal accent-4" @click="reveal = true"  class="text-h5">
                    修改信息
                  </v-btn>
                </v-card-actions>
            ...
            <v-col cols="6">
              <v-card class="mx-auto" width="550">
                <v-card-subtitle class="text-h5">我的提问</v-card-subtitle>
                <!-- code 2 begin -->
                <v-card-text>
                  <div>
                    <v-list flat>
                    ...
                    <v-icon v-text="item.icon"></v-icon>
                          ...
                          <v-btn
                            ...
                            color="teal accent-4"
                            class="text-h6"
                            @click="delete_question(item.id, i)"
                          >
                            删除
                          </v-btn>
                        </v-list-item>
...
export default {
  ...
  methods: {
    ...
    changeUserInfo() {
      ...
      data.append("old_username", sessionStorage.getItem("username_store"));
      data.append("old_password", sessionStorage.getItem("password_store")); //sessionStorage.getItem('password')
      if(this.username!=''){
          data.append("new_username", this.username);
      }
      if(this.password!=''){
